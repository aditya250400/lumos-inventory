...
export default function CreateLocationModal({ open, onOpenChange, users, action, method }) {
            ...
            <DialogContent className="sm:max-w-lg">
                <form onSubmit={submit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Isi nama lokasi. Jika lokasi ini memiliki sub lokasi (misal meja per orang), tambahkan di
                            bawah.
                        </DialogDescription>
                    </DialogHeader>
